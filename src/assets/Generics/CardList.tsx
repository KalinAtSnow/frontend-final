  ...
  return (
    <>
      <div className="p-8 bg-primary-50 flex flex-wrap">
        <div className="p-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 mx-auto lg:grid-cols-6 ">
          {cardData?.map((card) => (
            <div onClick={ () => cardClicked(card.card.id)}className="relative overflow-hidden cursor-pointer" key={card.card.id}>
